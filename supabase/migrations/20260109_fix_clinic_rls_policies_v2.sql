-- Migration: Fix Clinic RLS Policies (CORRECTED - No Recursion)
-- Date: 2026-01-09
-- Description: Adds RLS policies for clinics and clinic_members tables WITHOUT circular references
...
-- Policy: Admins can delete their own clinics
...
-- Policy: Users can view their own membership links (doctor or patient)
...
-- Policy: Admins can view all members of their clinics
